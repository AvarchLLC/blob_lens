...
export function AppNavbar() {
  ...
  return (
    <header className="sticky top-0 z-40 shrink-0">
      <nav className="h-14 bg-background/95 backdrop-blur-xl border-b border-border/30 flex items-center px-6 gap-4 animate-fade-in">
        ...
        <div className="hidden md:flex flex-1 max-w-xs lg:max-w-sm">
          <div className={cn(
            ...
            searchFocused
              ? 'bg-surface-elevated/80 border-primary/30 shadow-[0_0_12px_rgba(139,92,246,0.05)]'
              : 'bg-surface-elevated/40 border-border/30 hover:border-border/50 hover:bg-surface-elevated/60'
          )}>
            <Search className={cn(
            ...
            <kbd className={cn(
              ...
              searchFocused
                ...
                : 'border-border/20 text-text-secondary/30 bg-surface-elevated/50'
            )}>
              ⌘K
            </kbd>
          </div>
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          {mounted && (
            <button
              ...
              className="p-2 rounded-lg text-text-secondary/50 hover:text-text-primary hover:bg-surface-elevated/80 transition-all cursor-pointer"
            >
          ...
          <a
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-mono uppercase tracking-wider text-text-secondary/60 hover:text-text-primary bg-surface-elevated/40 border border-border/30 hover:border-border/50 hover:bg-surface-elevated/60 rounded-sm transition-all"
          >
