...
export function AppNavbar() {
  ...
  return (
    <header className="sticky top-0 z-40 shrink-0">
      <nav className="h-14 bg-[#090D16]/95 backdrop-blur-xl border-b border-white/5 flex items-center px-6 gap-4">
        ...
        <div className="hidden md:flex flex-1 max-w-xs lg:max-w-sm">
          <div className={cn(
            ...
            searchFocused
              ? 'bg-white/5 border-primary/30 shadow-[0_0_12px_rgba(139,92,246,0.05)]'
            ...
            <kbd className={cn(
              ...
              searchFocused
                ...
                : 'border-white/5 text-text-secondary/30 bg-white/2'
            )}>
              ⌘K
            </kbd>
          </div>
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          {mounted && (
            <button
              ...
              className="p-2 rounded-lg text-text-secondary/50 hover:text-text-primary hover:bg-white/3 transition-all cursor-pointer"
            >
          ...
          <a
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-mono uppercase tracking-wider text-text-secondary/60 hover:text-text-primary bg-white/2 border border-white/5 hover:border-white/10 hover:bg-white/4 rounded-sm transition-all"
          >
